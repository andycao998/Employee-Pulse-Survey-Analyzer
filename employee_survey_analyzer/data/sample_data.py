""" Some starting data of surveys and responses to work with """
...
RESPONSES = [
    ...
    # Positive sentiment
    {"body": "I'm impressed not only with what I've learned during my employment here but also the opportunities to take ownership of my work and to take on bigger responsibilities."},
    # Negative sentiment, contains PII (address)
    {"body": "As someone with 5 years of experience in this field at the Deloitte office at 1234 S. Big Rd. Chicago, IL, I'm surprised by the lack of opportunities coming my way. It feels like I haven't been able to take on larger tasks even if I have the experience and expertise."},
    # Negative sentiment
    {"body": "This past year has definitely been busier than previous years, so I felt that I didn't get as many opportunities to interact and collaborate with the rest of the team. I believe this has been a detriment to our work performance and I can feel more tension at least between myself and others. I definitely think there are moments in time where we can continue to work on our team culture that we haven't been taking advantage of."},
